...
public class MycontactController {
  ...
  public Object add(String name, String email, String java, String js, String py) {
    String contact = name + "," + email + "," + java + "," + js +"," + py;
  ...
  public Object update(String name, String email, String java, String js, String py) {
    String contact = name + "," + email + "," + java + "," + js +"," + py;
    for (int i = 0; i < size; i++) {
