...
public class Exam0114 {
  ...
  public static void main(String[] args) {
    ...
    Score s1 = createScore("홍길동", 100, 100, 100); // 홍길동, 100, 100,100파라미터 변수에 넘겨주는 값 : 아규먼트
    Score s2 = createScore("유관순", 100, 100, 100);
    Score s3 = createScore("안중근", 100, 100, 100);
    Score s4 = createScore("임꺽정", 100, 100, 100);
    Score s5 = createScore("홍범도", 100, 100, 100);
...
//클래스를 이용하면 성적 정보를 하나로 묶어 리턴할 수 있다.
 ...
 // name, kor, eng, math => 아규먼트를 받는 값 파라미터(로컬변수)
