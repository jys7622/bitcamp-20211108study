...
public class Exam0510 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(obj1.name); // A(A4,3,2 에는 name이 없다)
    ...
    System.out.println(((A3)obj1).working); // 없으면 수퍼 클래스의 필드를 가리킨다. true. A3에는 working이 없으니 상위로 찾아간다.
    System.out.println("-----------------------------");

    // 형변환 클래스에 존재하지 않는 필드는 가리킬 수 없다.
    //    System.out.println(((A)obj1).age); // 컴파일 오류!. A 클래스에 age가 없다.
