...
@RestController("lang.variable.Exam4") //클래스 이름이 같을 때 충돌 방지
...
public class Exam4 {
  ...
  public String test1(int v1, int v2, String op) {
    ...
    // 이렇게 서버에서 웹브라우저가 출력할 화면을 HTML로 만들어 보내는 것을
  ...
  // -> /static/lang/literal/variable/exam4/test1.html
  @GetMapping("/test2")
  public Object test2(int v1, int v2, String op) {   //Object를 쓰면 문자열, int둘다 리턴받을 수 있다.
  ...
  @GetMapping("/test3")
  public Object test3() {   //Object를 쓰면 문자열, int둘다 리턴받을 수 있다.
   
    String[] names = new String[] {"홍길동","유관순", "임꺽정" , "윤봉길", "안중근"};
