...
//     예) A.v1 = 200; - static 변수 v1 사용
//     예) System.out.println(A.v1); - static 변수 out 사용
//     예) Integer.parseInt(..); - static method parseInt() 사용
...
/* - 주의! Heap에는 개발자가 작성한 명령어가 없다. --> Heap에는 변수만 존재, method는 존재하지 않음*/
